...
This chapter tells us how to write and register a new optimization pass will be explored.

Different optimization levels can be unberstood by running the `opt` command-line interface on LLVM IR.
